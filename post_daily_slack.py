...
MESSAGES = [
    ...
    "*Safe to Go Tip:* :safety_vest: :safetogo: :gloves: Practise the team lift: Test the weight before lifting and use both hands. Ask for help if an item is too heavy or awkward.",
   
    "*Safe to Go Tip:* :safety_vest: Stretch it out: Stretch before and after work to reduce fatigue and improve range of motion.",
   
    "*Safe to Go Tip:* :safety_vest: Select the right tool: Use the correct equipment in the proper way to reduce effort and avoid unnecessary strain.",
   
    "*Safe to Go Tip:* :safety_vest: Reduce exposure to MSD risk factors: Test the weight of items before lifting, keep them close to your body, and take micro-breaks to stretch while working.",
]
